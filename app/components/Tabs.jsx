...
export function TabsDemo() {
  const tabs = [
    ...
    },
    {
      ...
      value: "services",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white border-2 bg-cover bg-center bg-no-repeat backdrop-blur-lg border-2 border-orange-500">
          <p>Authorized Centers</p>
          <DummyContent url={"https://private-user-images.githubusercontent.com/108949445/331582437-719948d6-18ad-4d0d-a89e-b704964743b2.jpg?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3MTU5NDY3NDgsIm5iZiI6MTcxNTk0NjQ0OCwicGF0aCI6Ii8xMDg5NDk0NDUvMzMxNTgyNDM3LTcxOTk0OGQ2LTE4YWQtNGQwZC1hODllLWI3MDQ5NjQ3NDNiMi5qcGc_.M3cZCMwsxsK8If99nF1j0hza0Ey2LjjWwbmsITa4p5Y"} />
        </div>
      ),
    },
    {
